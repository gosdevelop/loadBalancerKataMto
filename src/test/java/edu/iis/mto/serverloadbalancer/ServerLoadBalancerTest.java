...
public class ServerLoadBalancerTest {
    ...
    @Test
    public void balancingServerAddVms() {
        ...
        assertThat("server 1 should contain the first vm 1", server1.contains(vm1));
        assertThat("server 2 should contain the first vm 2", server2.contains(vm2));
        assertThat("server 1 should contain the first vm 3", server1.contains(vm3));
